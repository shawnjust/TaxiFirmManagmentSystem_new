 ...
 <link href="../../Content/css/BackControl/bootstrap.css" rel="stylesheet" type="text/css" />
	...
	<div class="row-fluid">
	    ...
	    <div class="hero-unit">
			...
			<p style="color:#30F">
			  欢迎登录长运出租车公司信息管理系统！在这里，你可以发布新闻，发布公司公告；也可以对以前发布的消息进行修改或删除的管理。您还可以查看每个客户的积分信息，方便了解客户的消费情况。当然，车主、司机、车辆等信息都会出现在后台的管理系统中，您有最大的管理权限；除此之外，对当前的数据备份时很重要的，如果有错误操作，请及时还原信息。建议您在对重要信息删除和修改之前都进行系统备份。</p>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<div class="row-fluid">
