...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="24" class="CenterUp"><table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
        <td width="77" height="24" align="center" valign="middle" class="UpSelect1" style="color:#06F;background-image:url(../../Content/picture/BackControl/CenterUp2Select.png);"><%:Html.ActionLink("备份","Backup","Home") %></td>
        <a>
        <td width="77" height="24" align="center" valign="middle" class="UpSelect1">还原</td></a>
        <td height="24">&nbsp;</td>
                    ...
                    <tbody>
                        <tr>
                          <td align="center"><input name="" type="checkbox" value="" />&nbsp;</td>
                            ...
                            <td>
                                盛雯（1152733）</td>
                            <td  style="color:#900" class="pointer">还原</td>
                        </tr>
                        <tr class="success">
                          <td align="center"><input name="input" type="checkbox" value="" /></td>
                            ...
                            <td><span style="color: #900"><span class="pointer" style="color:#900">还原</span></span></td>
                        </tr>
                        <tr class="error">
                          <td align="center"><input name="input2" type="checkbox" value="" /></td>
                            ...
                            <td><span class="pointer" style="color:#900">还原</span></td>
                        </tr>
                        <tr class="warning">
